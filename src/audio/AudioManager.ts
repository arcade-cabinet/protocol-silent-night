...
class AudioManagerClass {
  ...
  // Track last scheduled sound time to prevent Tone.js timing conflicts
  ...
  playSFX(effect: SoundEffect): void {
    ...
    // Ensure start time is strictly greater than last scheduled time
    // This prevents Tone.js "Start time must be strictly greater than previous start time" errors
    // when multiple sounds are triggered in rapid succession (e.g., during E2E tests)
