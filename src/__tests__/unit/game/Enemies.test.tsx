...
describe('Enemies Component', () => {
  ...
  describe('Rendering', () => {
    it('should render without crashing', () => {
      // Just test component creation without Canvas (avoid ResizeObserver issues)
      expect(Enemies).toBeDefined();
    });

    it('should not spawn enemies when in MENU state', () => {
      useGameStore.setState({ state: 'MENU', enemies: [] });
      expect(useGameStore.getState().enemies).toHaveLength(0);
    });
  });

  describe('Enemy Spawning', () => {
    it('should handle PHASE_1 state', () => {
