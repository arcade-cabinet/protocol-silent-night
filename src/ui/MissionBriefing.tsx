...
export function MissionBriefing() {
  ...
  // biome-ignore lint/correctness/useExhaustiveDependencies: briefingLines reference must be excluded to prevent infinite animation loops, but length is needed
  useEffect(() => {
    if (state !== 'BRIEFING') {
