...
test.describe('Full Gameplay - MECHA-SANTA (Tank Class)', () => {
  test('should complete full game loop with Santa', async ({ page }) => {
    await page.goto('/');
    await page.waitForFunction((ms) => new Promise(resolve => setTimeout(() => resolve(true), ms)), 2000);
  ...
  test('should have correct Santa stats and weapon', async ({ page }) => {
    ...
    await page.waitForFunction((ms) => new Promise(resolve => setTimeout(() => resolve(true), ms)), 3000);
    ...
    await page.waitForFunction((ms) => new Promise(resolve => setTimeout(() => resolve(true), ms)), 600); // Wait for at least one shot (0.5s delay)
  ...
  test('should survive longer due to high HP', async ({ page }) => {
    ...
    await page.waitForFunction((ms) => new Promise(resolve => setTimeout(() => resolve(true), ms)), 200);
  ...
  test('should trigger game over when HP reaches 0', async ({ page }) => {
    ...
    await page.waitForFunction((ms) => new Promise(resolve => setTimeout(() => resolve(true), ms)), 1000);
  ...
  test('should accumulate score and kills', async ({ page }) => {
    ...
    await page.waitForFunction((ms) => new Promise(resolve => setTimeout(() => resolve(true), ms)), 100);
...
test.describe('Full Gameplay - CYBER-ELF (Scout Class)', () => {
  ...
  test('should have low HP but rapid fire weapon', async ({ page }) => {
    ...
    await page.keyboard.down('Space');
    await page.waitForFunction((ms) => new Promise(resolve => setTimeout(() => resolve(true), ms)), 500); // Half second of firing
    await page.keyboard.up('Space');
  ...
  test('should die quickly with low HP', async ({ page }) => {
    ...
    await triggerStoreAction(page, 'damagePlayer', 100);
    await page.waitForFunction((ms) => new Promise(resolve => setTimeout(() => resolve(true), ms)), 500);
...
test.describe('Full Gameplay - Boss Battle', () => {
  ...
  test('should show boss health decreasing', async ({ page }) => {
    ...
    for (let i = 0; i < 10; i++) {
      await triggerStoreAction(page, 'addKill', 10);
      await page.waitForFunction((ms) => new Promise(resolve => setTimeout(() => resolve(true), ms)), 20);
    }
    await page.waitForFunction((ms) => new Promise(resolve => setTimeout(() => resolve(true), ms)), 500);
...
test.describe('Full Gameplay - Kill Streaks', () => {
  ...
  test('should reset streak after timeout', async ({ page }) => {
    ...
    await page.waitForFunction((ms) => new Promise(resolve => setTimeout(() => resolve(true), ms)), 2500);
  ...
  test('should apply streak bonus to score', async ({ page }) => {
    ...
    await page.waitForFunction((ms) => new Promise(resolve => setTimeout(() => resolve(true), ms)), 50);
...
test.describe('Full Gameplay - Input Controls', () => {
  ...
  test('should respond to arrow key movement', async ({ page }) => {
    ...
    await page.waitForFunction((ms) => new Promise(resolve => setTimeout(() => resolve(true), ms)), 300);
