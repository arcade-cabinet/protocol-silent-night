...
import { getGameState, selectCharacter, startMission, triggerStoreAction, waitForLoadingScreen } from './utils';
...
test.describe('Full Gameplay - Kill Streaks', () => {
  ...
  test('should reset streak after timeout', async ({ page }) => {
    ...
    // Streak times out after 2+ seconds (no explicit wait needed, just check result)
