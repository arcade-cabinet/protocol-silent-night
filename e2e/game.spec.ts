...
test.describe('Protocol: Silent Night', () => {
  ...
  test('should render canvas element', async ({ page }) => {
    ...
    const timeout = hasMcpSupport ? 3000 : 2500;
    await page.waitForFunction((ms) => new Promise(resolve => setTimeout(() => resolve(true), ms)), timeout);
  ...
  test('should start game when selecting character', async ({ page }) => {
    ...
    await page.waitForFunction(() => new Promise(resolve => setTimeout(() => resolve(true), 3000)));
