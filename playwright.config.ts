...
export default defineConfig({
  ...
  timeout: hasMcpSupport ? 60000 : 180000,
  // Reporter to use
  ...
  expect: {
    ...
    toHaveScreenshot: {
      // Allow 5% pixel difference by default for WebGL rendering variations
      // Individual tests can override with higher thresholds if needed
